...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'electron-store'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
function createWindow(windowName, options) {
  ...
  const store = new Object(function webpackMissingModule() { var e = new Error("Cannot find module 'electron-store'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
    name
  });
  const defaultSize = {
    width: options.width,
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'electron-serve'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
